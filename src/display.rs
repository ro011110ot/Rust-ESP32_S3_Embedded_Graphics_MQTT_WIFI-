...
fn draw_weather_icon<D: DrawTarget<Color = Rgb565>>(
    ...
    let data: &[u8] = match code {
        "01d" => include_bytes!("../icons_png/01d.png"),
        "01n" => include_bytes!("../icons_png/01n.png"),
        "02d" => include_bytes!("../icons_png/02d.png"),
        "02n" => include_bytes!("../icons_png/02n.png"),
        "03d" => include_bytes!("../icons_png/03d.png"),
        "03n" => include_bytes!("../icons_png/03n.png"),
        "04d" => include_bytes!("../icons_png/04d.png"),
        "04n" => include_bytes!("../icons_png/04n.png"),
        "09d" => include_bytes!("../icons_png/09d.png"),
        "09n" => include_bytes!("../icons_png/09n.png"),
        "10d" => include_bytes!("../icons_png/10d.png"),
        "10n" => include_bytes!("../icons_png/10n.png"),
        "11d" => include_bytes!("../icons_png/11d.png"),
        "11n" => include_bytes!("../icons_png/11n.png"),
        "13d" => include_bytes!("../icons_png/13d.png"),
        "13n" => include_bytes!("../icons_png/13n.png"),
        "50d" => include_bytes!("../icons_png/50d.png"),
        "50n" => include_bytes!("../icons_png/50n.png"),
        _ => return Ok(()),
    };
